...
<form action="{{ route('suppliers.update',$supplier->url_string) }}" method="POST">
  @csrf
  @method('PUT')
  ...
  <div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
      <div class="form-group">
        ...
        <input type="text" name="location" value="{{ $supplier ->location }}" class="form-control" placeholder="Location">
      </div>
    </div>
